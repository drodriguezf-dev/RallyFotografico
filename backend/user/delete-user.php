...
try {
    ...
    if (!$usuario || $usuario['rol_id'] != 3) {
        header("Location: ../public/gestion-usuarios.php?error=Usuario+no+válido");
        exit;
    }
    ...
    header("Location: ../public/gestion-usuarios.php?exito=Usuario+eliminado+correctamente");
    exit;

} catch (PDOException $e) {
    header("Location: ../public/gestion-usuarios.php?error=Error+al+eliminar+el+usuario");
    exit;
}
