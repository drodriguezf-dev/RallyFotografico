        ...
        <nav class="bg-green-300 shadow p-4 flex justify-between items-center">
            ...
            <div class="relative">
                <?php if (!isset($_SESSION['usuario_id']) && !isset($_SESSION['admin_id'])): ?>
                    ...
                    <a href="../sessions/login.php" class="bg-amber-300 hover:bg-amber-400 text-white font-semibold py-2 px-4 rounded transition">
                        Iniciar sesión
                    </a>
                <?php else: ?>
                    ...
                    <div id="user-menu" class="absolute right-0 mt-2 w-56 bg-gray-50 border border-gray-200 rounded-lg shadow-lg hidden z-50">
                        <div class="px-4 py-2 text-sm text-gray-700 font-semibold border-b bg-gray-100">Opciones de cuenta</div>
                            ...
                            <?php if ($_SESSION['rol_id'] == 3): ?>
                                <a href="../usuarios/mis-fotos.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-200 rounded transition">
                                    Ver mis fotos
                                </a>
                                <a href="../usuarios/cuenta.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-200 rounded transition">
                                    Cambiar mis datos
                                </a>
                            <?php elseif ($_SESSION['rol_id'] == 2): ?>
                                <a href="gestionar-fotos.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-200 rounded transition">
                                    Gestionar fotografías
                                </a>
                                <a href="crear-concurso.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-200 rounded transition">
                                    Crear concurso
                                </a>
                                <a href="../usuarios/cuenta.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-200 rounded transition">
                                    Cambiar mis datos
                            ...
                            <?php elseif ($_SESSION['rol_id'] == 1): ?>
                                ...
                                <a href="../public/gestion-usuarios.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-200 rounded transition">
                                    Gestionar usuarios
                                </a>
                            <?php endif; ?>
                            <a href="../sessions/logout.php" class="block px-4 py-2 text-sm text-red-600 hover:bg-red-100 rounded transition">
                                Cerrar sesión
                            </a>
                    </div>
                <?php endif; ?>
                        ...
                        <div class="bg-white p-6 rounded shadow hover:shadow-lg transition">
                            ...
                            <div class="mt-4 text-center flex justify-center space-x-4">
                                <?php if (!isset($_SESSION['rol_id']) && !isset($_SESSION['usuario_id'])): ?>
                                    ...
                                    <a href="votar-concurso.php?id=<?= $concurso['id'] ?>" class="bg-purple-500 hover:bg-purple-600 text-white font-semibold py-2 px-4 rounded transition">
                                        Votar
                                    </a>
                                <?php elseif (isset($_SESSION['rol_id']) && $_SESSION['rol_id'] == 3): ?>
                                    <!-- Botón para usuarios con rol_id == 3 -->
                                    <a href="participar-concurso.php?id=<?= $concurso['id'] ?>" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded transition">
                                        Participar
                                    </a>
                                <?php endif; ?>
                                ...
                                <?php if (isset($_SESSION['rol_id']) && ($_SESSION['rol_id'] == 1 || $_SESSION['rol_id'] == 2)): ?>
                                    ...
                                    <a href="modificar-concurso.php?id=<?= $concurso['id'] ?>" class="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold py-2 px-4 rounded transition">
                                        Modificar
                                    </a>
                                <?php endif; ?>
                            </div>
