...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($email) && !empty($password)) {
        ...
        if ($admin && password_verify($password, $admin['password'])) {
            ...
            header("Location: ../public/index.php"); // Ruta al panel de administración
            exit;
        } else {
...
<body class="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#1a1a1a] to-[#3a3a3a]">
    ...
    <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
        ...
        <form id="login-form" method="POST" action="login-admin.php" class="space-y-4">
            <div>
        ...
        <div class="mt-4 text-center">
            ...
            <p class="text-sm text-gray-600 mt-2">
                <a href="login.php" class="text-amber-500 hover:text-amber-600 font-semibold">Soy un usuario</a>
            </p>
        </div>
    </div>
