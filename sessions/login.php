    ...
    <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
        ...
        <div class="mt-4 text-center">
            <p class="text-sm text-gray-600">¿No tienes una cuenta? 
                <a href="register.php" class="text-amber-500 hover:text-amber-600 font-semibold">Crea una aquí</a>
            </p>
            <p class="text-sm text-gray-600 mt-2">
                <a href="../public/index.php" class="text-amber-500 hover:text-amber-600 font-semibold">Volver al inicio</a>
            </p>
            <p class="text-sm text-gray-600 mt-2">
                <a href="login-admin.php" class="text-amber-500 hover:text-amber-600 font-semibold">Acceso para trabajadores</a>
            </p>
        </div>
    </div>
